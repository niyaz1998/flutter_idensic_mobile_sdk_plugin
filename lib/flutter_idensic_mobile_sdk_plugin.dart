...
class SNSMobileSDK {
  ...
  Future<String?> _onMethodCallHandler(MethodCall call) async {
    switch(call.method) {
      ...
      case "onActionResult":
        final SNSActionResultHandlerReaction reaction = await onActionResult!(_toActionResult(call.arguments[0]));
...
class SNSMobileSDKBuilder {
  ...
  SNSMobileSDKBuilder withHandlers({SNSStatusChangedHandler? onStatusChanged, SNSActionResultHandler? onActionResult, SNSEventHandler? onEvent}) {
...
class SNSMobileSDKResult {
  ...
  String toString() => 'SNSMobileSDKResult(success: $success, status: $status, errorType: $errorType, errorMsg: $errorMsg, actionResult: $actionResult)';
...
class SNSMobileSDKActionResult {
  ...
  @override
  String toString() => 'SNSMobileSDKActionResult(actionId: $actionId, answer: $answer, actionType: $actionType, allowContinuing: $allowContinuing)';

  @override
  bool operator ==(Object o) {
    if (identical(this, o)) return true;

    return o is SNSMobileSDKActionResult &&
      o.actionId == actionId &&
      o.answer == answer;
  }
...
SNSMobileSDKActionResult _toActionResult(Map<dynamic, dynamic> value) {
  ...
  return SNSMobileSDKActionResult(value['actionId'] ?? 'Unknown', value['actionType'] ?? 'Unknown', _toAnswerType(value['answer']), value['allowContinuing'] ?? false);
}
